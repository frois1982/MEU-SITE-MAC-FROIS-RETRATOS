...
export const Home: React.FC = () => {
    useEffect(() => {
          ...
          if (meta) meta.setAttribute('content', 'Mac Frois e fotografo especialista em retratos corporativos e posicionamento de imagem para executivos e empresarios em Florianopolis, SC. Conheca o Metodo Frois.');
                  ...
                  try {
                            ...
                            if (res.ok) {
                                        ...
                                        if (data.resources && Array.isArray(data.resources)) {
                                                      const homeTagged = data.resources.filter((f: any) => {
                                                                      const name = (f.public_id || '').toUpperCase();
                                                                      return name.includes('_HOME');
                                                      });
                                                      const artFallback = data.resources.filter((f: any) => {
                                                                      const name = (f.public_id || '').toUpperCase();
                                                                      return name.startsWith('ART_') && !name.includes('_HOME');
                                                      });
                                                      const combined = [...homeTagged, ...artFallback]
                                                        .slice(0, 4)
                                                        .map((file: any) => {
                                                                          const nameUpper = (file.public_id || '').toUpperCase();
                            ...
                            console.error('Erro Home Cloudinary:', err);
                  } finally {
                            setLoading(false);
                  }
          };
    ...
    const whatsappUrl = "https://wa.me/5548996231894?text=Ola%20Mac,%20vi%20seu%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20os%20retratos%20de%20posicionamento.";
          ...
          <div className="text-zinc-200">
                  ...
                  {/* Slide atual */}
                        <div
                                  ...
                                  <img
                                                ...
                                                alt="Mac Frois Retrato"
                                                className="w-full h-full object-cover opacity-50"
                                              />
                        </div>div>
                
                  {/* Proximo slide (preload) */}
                        <div className="absolute inset-0 z-0 opacity-0">
                                  <img
                                                src={SLIDE_IMAGES[nextSlide]}
                                                alt=""
                  ...
                  {/* Conteudo */}
                        <div className="relative z-20 w-full max-w-7xl mx-auto px-6 flex flex-col justify-end h-full pb-20">
                                  <div className="max-w-xl">
                                              <p className="text-gold-500 text-xs tracking-[0.4em] uppercase mb-4">Florianopolis, Brasil</p>p>
                                              <h1 className="text-5xl md:text-7xl font-serif text-white mb-4 leading-tight">
                                                            Imagem e<br />Autoridade
                                              </h1>h1>
                                              <p className="text-zinc-400 text-sm tracking-widest uppercase mb-10">
                                                            A ciencia por tras do retrato estrategico.
                                              </p>p>
                                              <div className="flex flex-wrap gap-3">
                                                            <button
                                                                              onClick={() => navigate('/portfolio')}
                                                                              className="px-6 py-2.5 border border-gold-600 text-gold-500 text-xs tracking-[0.2em] uppercase hover:bg-gold-600/10 transition-all duration-300"
                                                                            >
                                                                            Portfolio
                                                            </button>button>
                                                            <a
                                                                              ...
                                                                              className="px-6 py-2.5 border border-zinc-600 text-zinc-400 text-xs tracking-[0.2em] uppercase hover:border-gold-600 hover:text-gold-500 transition-all duration-300 flex items-center gap-2"
                                                                            >
                                                            ...
                                                            <button
                                                                              ...
                                                                              className="px-6 py-2.5 border border-zinc-600 text-zinc-400 text-xs tracking-[0.2em] uppercase hover:border-gold-600 hover:text-gold-500 transition-all duration-300"
                                                                            >
                                                                            Projetos
                                                            </button>button>
                                              </div>div>
                          ...
                          <button
                                            ...
                                            className={`w-1.5 h-1.5 rounded-full transition-all duration-300 ${i === currentSlide ? 'bg-gold-500 w-4' : 'bg-zinc-600'}`}
                                          />
                        ))}
                                  </div>div>
                        </div>div>
            ...
            {/* Manifesto Section */}
                <section className="py-32 bg-black border-y border-zinc-900 overflow-hidden relative">
                        <div className="absolute top-0 right-0 w-full h-full bg-gold-600/5 pointer-events-none"></div>div>
                        <div className="container mx-auto px-6 relative z-10">
                                  <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                                              <div className="lg:w-1/2 relative">
                                                            <div className="absolute -top-10 -left-10 w-40 h-40 border-t border-l border-gold-600/20 hidden lg:block"></div>div>
                                                            <div className="absolute -bottom-10 -right-10 w-40 h-40 border-b border-r border-gold-600/20 hidden lg:block"></div>div>
                                                            ...
                                                            <div className="relative aspect-[4/5] overflow-hidden shadow-2xl rounded-sm border border-zinc-800">
                                                                            <img
                                                                                              ...
                                                                                              />
                                                                            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent"></div>div>
                                                                            <div className="absolute bottom-10 left-10">
                                                                                              <span className="text-gold-500 text-[10px] font-bold tracking-[0.5em] uppercase">Mac Frois</span>span>
                                                                                              <p className="text-white text-xs tracking-widest uppercase italic font-light mt-1">Retratista</p>p>
                                                                            </div>div>
                                                            </div>div>
                                              </div>div>
                                              ...
                                              <div className="lg:w-1/2 space-y-10">
                                                            <div className="space-y-4">
                                                                            <span className="text-gold-500 text-[10px] font-bold uppercase tracking-[0.6em] block">O Manifesto</span>span>
                                                                            <h2 className="text-4xl md:text-6xl font-serif text-white italic tracking-widest leading-tight">
                                                                                              A Verdade e o unico <br/>
                                                                                              <span className="text-gold-500/90">filtro que importa.</span>span>
                                                                            </h2>h2>
                                                            </div>div>
                                                            ...
                                                            <div className="relative p-10 bg-zinc-900/70 backdrop-blur-3xl border border-zinc-800/50 rounded-sm shadow-2xl">
                                                                            ...
                                                                            <p className="text-zinc-300 text-lg md:text-xl font-light leading-relaxed tracking-wide font-serif italic mb-8">
                                                                                              "Minha missao nao e criar uma mascara, mas revelar a autoridade que ja habita em voce. Atraves da luz e da semiotica, traduzimos sua essencia em um ativo estrategico de poder."
                                                                            </p>p>
                                                                            <p className="text-zinc-500 text-sm uppercase tracking-[0.2em] leading-loose font-light">
                                                                                              Nao fazemos apenas fotos. Criamos narrativas visuais que posicionam voce no topo do seu mercado. Em um mundo saturado de filtros, a autenticidade e o luxo definitivo.
                                                                            </p>p>
                                                            </div>div>
            ...
            {/* Featured Portfolio */}
                <section className="py-32 bg-zinc-950">
                                          ...
                                          <div
                                                            ...
                                                            <div className="absolute inset-0 bg-black/50 backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-all duration-700 flex items-center justify-center p-6">
                                                                                <div className="text-center border border-white/10 bg-white/5 backdrop-blur-3xl p-8 w-full h-full flex flex-col items-center justify-center scale-90 group-hover:scale-100 transition-transform duration-700">
                                                                                                      <span className="text-white text-[11px] tracking-[0.5em] uppercase border-b border-gold-600/50 pb-3 block mb-4 font-bold">Ver Obra</span>span>
                                                                                                      <span className="text-gold-500 text-[9px] tracking-[0.4em] uppercase opacity-80 italic font-medium">{item.title}</span>span>
                                                                                  </div>div>
                                                            </div>div>
                                          </div>div>
                                        ))}
                        ...
                        <div className="text-center py-24 text-zinc-800 tracking-[0.6em] uppercase text-xs border border-dashed border-zinc-900 rounded-lg mt-16 font-bold">
                                      Sincronize arquivos para destacar fotos aqui.
                        </div>div>
                                  )}
                        </div>div>
                </section>section>
