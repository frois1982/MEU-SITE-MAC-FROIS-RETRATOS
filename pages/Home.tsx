...
export const Home: React.FC = () => {
  ...
  const handleAiConsultation = async (e: React.FormEvent) => {
    ...
    setAiLoading(true);
    try {
      // Cria a instância da IA usando a chave que você vai configurar na Vercel
      ...
      alert("Estamos ajustando a conexão com a inteligência. Tente novamente em instantes.");
    }
    setAiLoading(false);
  };
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <span className="text-gold-500 text-[10px] font-bold uppercase tracking-[0.5em] mb-4 block">Espaço Mac Frois • IA</span>
              ...
              <p className="text-zinc-500 text-sm tracking-[0.2em] uppercase max-w-xl mx-auto font-light">
                Descubra em segundos qual a melhor estratégia visual para seu posicionamento atual.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-start">
              <div className="space-y-8">
                <form onSubmit={handleAiConsultation} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      placeholder="Ex: Executivo, Artista, Médico..."
                      required
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      placeholder="Ex: Confiança, Poder, Criatividade..."
                      required
                      className="w-full bg-zinc-900/50 border border-zinc-800 p-4 text-white focus:border-gold-600 outline-none rounded-sm text-sm font-light tracking-wide transition-all"
                    />
                  </div>
                  ...
                  {!recommendation ? (
                    ...
                    >
                      ...
                      {aiLoading ? 'ANALISANDO ESSÊNCIA...' : 'GERAR DIAGNÓSTICO'}
                    </Button>
                  ) : (
                    <Button 
                ...
                <div className="p-6 border-l-2 border-zinc-900 bg-zinc-900/30 rounded-r-md backdrop-blur-sm">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-white text-[9px] font-bold uppercase tracking-widest">Protocolo Seguro</span>
                  </div>
                  <p className="text-zinc-600 text-[10px] uppercase leading-relaxed tracking-widest">
                    Análise baseada em semiótica e branding pessoal aplicado no estúdio.
                  </p>
                </div>
              </div>
              ...
              <div className="relative min-h-[420px]" ref={resultRef}>
                <div className={`transition-all duration-700 transform ${recommendation ? 'opacity-100 translate-y-0' : 'opacity-20 blur-md pointer-events-none translate-y-10'}`}>
                  <Card className="border-gold-600/30 bg-zinc-900/70 backdrop-blur-xl h-full flex flex-col justify-between shadow-2xl relative overflow-hidden">
                    ...
                    <div>
                      <h4 className="text-gold-500 text-[10px] font-bold tracking-[0.5em] uppercase mb-8 border-b border-zinc-800 pb-4 flex items-center gap-3">
                        <Zap size={14} /> Seu Perfil de Imagem
                      </h4>
                      
                      {recommendation && (
                        <div className="space-y-8 animate-fade-in">
                          <div>
                            <span className="text-zinc-500 text-[10px] uppercase tracking-widest block mb-2 font-bold">Projeto Indicado</span>
                            <p className="text-white text-3xl font-serif tracking-widest uppercase italic">{recommendation.projeto}</p>
                          </div>
                          <div>
                            <span className="text-zinc-500 text-[10px] uppercase tracking-widest block mb-2 font-bold">Estratégia Narrativa</span>
                            <p className="text-zinc-200 text-sm font-light tracking-wide italic leading-relaxed border-l border-gold-600/50 pl-4">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="bg-black/30 p-4 rounded-sm border border-zinc-800/50">
                              <span className="text-zinc-500 text-[9px] uppercase tracking-widest block mb-2 font-bold">Dica Visual</span>
                    ...
                    <div className="mt-12 flex flex-col gap-3 relative z-10">
                      <Link to="/servicos">
                        <Button className="w-full py-4 text-[10px] tracking-[0.3em] !bg-gold-600/90 hover:!bg-gold-600">
                          CONHECER ESTE PROJETO <ArrowRight size={14} className="ml-2 inline" />
                        </Button>
                      </Link>
                ...
                {!recommendation && !aiLoading && (
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-12 animate-pulse">
                    ...
                    <p className="text-zinc-700 text-[10px] tracking-[0.5em] uppercase font-bold">Aguardando dados para diagnóstico...</p>
                  </div>
                )}
                {aiLoading && (
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-12">
                    <div className="w-32 h-1 bg-zinc-900 mb-8 overflow-hidden rounded-full">
                       <div className="w-full h-full bg-gold-600 animate-[loading_2s_ease-in-out_infinite]"></div>
                    </div>
                    <Loader2 size={48} className="text-gold-600 animate-spin mb-6" />
                    <p className="text-gold-500 text-[10px] tracking-[0.5em] uppercase font-bold">Mapeando Autoridade...</p>
                  </div>
                )}
              </div>
            </div>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          {loading ? (
            ...
            <div className="text-center py-20 text-zinc-800 tracking-[0.5em] uppercase text-xs border border-dashed border-zinc-900 rounded-lg mt-16">
              Use a tag '_HOME' no Drive para destacar fotos aqui.
            </div>
          )}
          
          <div className="mt-16">
             <Link to="/portfolio" className="text-gold-500 hover:text-white transition-colors text-xs tracking-[0.5em] uppercase font-bold border-b border-gold-600/30 pb-1">Ver Portfólio Completo →</Link>
          </div>
        </div>
      </section>
    </div>
